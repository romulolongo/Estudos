...
namespace Program01._03
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var procedimento = Parallel.For(0, 99, (int i, ParallelLoopState state) =>
             {
                 if (i == 75 || i == 76)
                     state.Break();
            ...
            Console.WriteLine("Completou sem interrupção? {0}", (procedimento.IsCompleted ? "Sim" : "Não"));
            Console.WriteLine("Quantos itens foram processados (parcialmente)? {0}", procedimento.LowestBreakIteration);
